...
print'
	...
	<ul class="promos">
		<li id="promo1">
    		<a href="'.$protocol.$site.'/news/article/'.$home_news[0]['article'].'" style="background-image:url(\'http://hoaumich.org/img/user/'.$home_news[0]['image'].'\');">
        ...
        <li id="promo2">
    		<a href="'.$protocol.$site.'/news/article/'.$home_news[1]['article'].'" style="background-image:url(\'http://hoaumich.org/img/user/'.$home_news[1]['image'].'\');">
    			<div class="promo-text">
        ...
        <li id="promo3">
    		<a href="'.$protocol.$site.'/news/article/'.$home_news[2]['article'].'" style="background-image:url(\'http://hoaumich.org/img/user/'.$home_news[2]['image'].'\');">
    			<div class="promo-text">
